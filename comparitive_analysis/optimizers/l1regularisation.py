...
for optimizer_name, optimizer in optimizers.items():
    ...
    model = Sequential()
    model.add(Dense(128, input_shape=(len(training[0]),), kernel_regularizer=l1(regularization_strength)))
    model.add(Activation('relu'))

    model.add(Dense(256, kernel_regularizer=l1(regularization_strength)))
    model.add(Activation('relu'))

    model.add(Dropout(0.5))

    model.add(Dense(128, kernel_regularizer=l1(regularization_strength)))
    model.add(Activation('relu'))
