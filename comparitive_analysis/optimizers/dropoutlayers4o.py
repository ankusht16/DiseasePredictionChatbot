...
# Models
models = {
    'Single Layer': [Dense(128, input_shape=(len(training[0]),)), Activation('relu'), Dropout(0.5)],
    'Two Layer': [Dense(128, input_shape=(len(training[0]),)), Activation('relu'), Dropout(0.5),
                  Dense(128), Activation('relu'), Dropout(0.5)],
    'Three Layer': [Dense(128, input_shape=(len(training[0]),)), Activation('relu'), Dropout(0.5),
                    Dense(128), Activation('relu'), Dropout(0.5),
                    Dense(128), Activation('relu'), Dropout(0.0)],
    'Four Layer': [Dense(128, input_shape=(len(training[0]),)), Activation('relu'), Dropout(0.5),
                   Dense(128), Activation('relu'), Dropout(0.5),
                   Dense(128), Activation('relu'), Dropout(0.0),
                   Dense(128), Activation('relu'), Dropout(0.0)],
    'Five Layer': [Dense(128, input_shape=(len(training[0]),)), Activation('relu'), Dropout(0.5),
                   Dense(128), Activation('relu'), Dropout(0.5),
                   Dense(128), Activation('relu'), Dropout(0.0),
                   Dense(128), Activation('relu'), Dropout(0.0),
                   Dense(128), Activation('relu'), Dropout(0.0)],
    'Six Layer': [Dense(128, input_shape=(len(training[0]),)), Activation('relu'), Dropout(0.5),
                  Dense(128), Activation('relu'), Dropout(0.5),
