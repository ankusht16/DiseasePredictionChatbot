...
# Models
models = {
    'Single Layer': [Dense(128, input_shape=(len(training[0]),)), Activation('relu')],
    'Two Layer': [Dense(128, input_shape=(len(training[0]),)), Activation('relu'),
                  Dense(128), Activation('relu')],
    'Three Layer': [Dense(128, input_shape=(len(training[0]),)), Activation('relu'),
                    Dense(128), Activation('relu'),
                    Dense(128), Activation('relu')],
    'Four Layer': [Dense(128, input_shape=(len(training[0]),)), Activation('relu'),
                   Dense(128), Activation('relu'),
                   Dense(128), Activation('relu'),
                   Dense(128), Activation('relu')],
    'Five Layer': [Dense(128, input_shape=(len(training[0]),)), Activation('relu'),
                   Dense(128), Activation('relu'),
                   Dense(128), Activation('relu'),
                   Dense(128), Activation('relu'),
                   Dense(128), Activation('relu')],
    'Six Layer': [Dense(128, input_shape=(len(training[0]),)), Activation('relu'),
                  Dense(128), Activation('relu'),
                  Dense(128), Activation('relu'),
                  Dense(128), Activation('relu'),
                  Dense(128), Activation('relu'),
